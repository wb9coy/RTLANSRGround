...
class HABPacketImageSeqStartType(ctypes.LittleEndianStructure):
    _pack_   = 1
    _fields_ = [
        ("packetType",    c_uint16),
        ("imageFileID",   c_uint8),
...
class HABPacketImageSeqDataType(ctypes.LittleEndianStructure):
    name     = "HABPacketImageDataType"
    _pack_   = 1
    _fields_ = [
        ("packetType",    c_uint16),
...
class HABPacketImageSeqEndType(ctypes.LittleEndianStructure):
    _pack_   = 1
    _fields_ = [
        ("packetType",    c_uint16),
        ("imageFileID",   c_uint8),
...
class webHABPacketDataType(ctypes.LittleEndianStructure):
    _pack_   = 1
    _fields_ = [
        ("packetType", c_uint16),
        ("webDataLen", c_uint8),
        ("webData",    c_uint8*MAX_WEB_BUF_LEN)        
        ] 